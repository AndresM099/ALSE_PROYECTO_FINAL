...
QT_MOC_LITERAL(1, 12, 15), // "usuarioCorrecto"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "ingresar"
QT_MOC_LITERAL(4, 38, 28), // "on_pushButton_loging_clicked"
QT_MOC_LITERAL(5, 67, 30) // "on_pushButton_register_clicked"

    },
    "DialogLogin\0usuarioCorrecto\0\0ingresar\0"
    "on_pushButton_loging_clicked\0"
...
void DialogLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->usuarioCorrecto((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_loging_clicked(); break;
        ...
        {
            using _t = void (DialogLogin::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DialogLogin::usuarioCorrecto)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DialogLogin::usuarioCorrecto(int _t1)
{
